...
<div class="idsk-card idsk-card-secondary">
	<a href="$Link" title="$Title">
		...
		<% else %>
			<img src="$resourceURL('themes/id-sk/images/image-placeholder.jpg')" alt="$Title" aria-hidden="true" class="idsk-card-img idsk-card-img-secondary">
		<% end_if %>
	</a>
	<div class="idsk-card-content idsk-card-content-secondary">
		...
		<div class="idsk-body idsk-body-secondary typography">
